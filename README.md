# 中国 A 股 AI 算力与半导体股票池预测系统

一个面向中国 A 股 AI 算力与半导体主线的本地量化研究项目。项目使用 AKShare 免费日线行情、本地 CSV / Parquet 文件、LightGBM 分类模型和可配置仓位规则，预测股票未来 20 个交易日跑赢 AI 股票池平均收益的概率，并生成建议仓位、简化回测和 Markdown 报告。

> 本项目仅用于个人学习、量化研究和代码实验，不构成任何投资建议。模型结果不能直接用于实盘交易，回测不代表未来收益。

## 项目特点

- 聚焦中国 A 股 AI 算力与半导体主线。
...
银行、白酒、传统消费、地产、煤炭、石油、公用事业、新能源车、机器人、创新药、军工等暂时不进入可投资池。其他行业未来可以作为风格监控变量，但第一版先不做。
